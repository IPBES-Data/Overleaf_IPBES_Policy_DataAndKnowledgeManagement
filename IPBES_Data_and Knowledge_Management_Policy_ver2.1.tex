...
\todo[inline]{Check other glossary items for consistency witn IPBES terminology and adjust if needed}
\todo[inline]{Add AI COP as appendix to the policy and change wording in the policy accordingly}
\todo[inline]{Change outline to fall in line with IPBES formatting ideas / recommendations / guidelinesz / requirements}
